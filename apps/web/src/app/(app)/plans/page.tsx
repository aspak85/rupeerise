...
export default function PlansPage() {
  ...
  const load = useCallback(async () => {
    ...
    setPlans(plans);
    setDepositBal(Number(me.totals.byType["deposit"] ?? 0));
  }, []);
          ...
          return (
            ...
            >
              ...
              <ul className="mt-4 space-y-2 text-sm text-zinc-300 flex-1">
                ...
                <li className="flex items-center gap-2 text-zinc-400"><ShieldCheck size={14} className="text-yellow-400" /> Weekly Sunday withdrawals</li>
              </ul>
              <button
                onClick={() => buy(p)}
